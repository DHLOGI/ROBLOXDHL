...
export async function POST(req: Request) {
  try {
    ...
    return new Response(
      JSON.stringify({ error: 'Error interno en la API de Groq' }),
      {
        status: 500,
